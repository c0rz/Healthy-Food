...
<head>
  ...
  <link href="<?= base_url($list_config['base_css']) ?>/bootstrap-admin.css" rel="stylesheet">
</head>

<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-light bg-light">
    <a class="navbar-brand" href="<?= base_url() ?>"><?= $list_config['title'] ?></a><button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button><!-- Navbar Search-->
  ...
  <footer class="py-4 bg-light mt-auto">
    <div class="container-fluid">
      <div class="d-flex align-items-center justify-content-between small">
        <div class="text-muted">Copyright &copy; <?= $list_config['title'] ?> 2020</div>
        <div>
  ...
  <script src="<?= base_url(); ?>assets/js/geser.js"></script>
</body>
